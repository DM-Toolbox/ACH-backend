...
app.use('/api/v1/chestRewards', require('./controllers/chestRewards'));
app.use('/api/v1/dragons', require('./controllers/dragons'));
app.use('/api/v1/mounts', require('./controllers/mounts'));
app.use('/api/v1/resistances', require('./controllers/resistances'));
app.use('/api/v1/weapons', require('./controllers/weapons'));
app.use('/api/v1/weaponWarnings', require('./controllers/weaponWarnings'));
